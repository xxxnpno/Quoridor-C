...
void printRules() 
{
	...
	printf("3. Walls are placed between two squares to block an opponent’s movement, but they cannot completely block a player's path to the opposite side.\n");
